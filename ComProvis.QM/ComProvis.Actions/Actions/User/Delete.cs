...
{
    [Provision(ProvisionType.DeleteUser)]
    public class Delete : Job
    {
        ...
        public Delete(IOrderDemandRepository orderDemandRepository, ILogRepository logRepository, IUserRepository CompanyRepository) : base(logRepository)
        {
